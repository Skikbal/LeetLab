  ...
  return (
    <div className="p-4">
      ...
      <div className="flex gap-2 my-3">
        <div className="badge rounded-xl bg-accent cursor-pointer capitalize text-warning font-medium text-nowrap">
      ...
      <div className="flex flex-col mt-10 gap-3">
        {Object.entries(problem?.examples).map(([language, example], index) => {
          return (
            <div
              className="bg-base-200 rounded-md p-2 text-nowrap min-w-120 border border-accent w-full"
              key={language}
            >
