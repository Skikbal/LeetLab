...
const PlaylistProfile = ({ playlists,handleDelete,setIsPlaylistModalOpen }) => {
    ...
    <div className="py-4 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="btn btn-primary btn-sm rounded-md mr-5" onClick={() => setIsPlaylistModalOpen(true)}>
            Create Playlist
          </button>
        </div>
        ...
        {playlists?.length === 0 ? (
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions justify-center mt-4">
                <button className="btn btn-primary" onClick={() => setIsPlaylistModalOpen(true)}>Create Playlist</button>
              </div>
            </div>
          </div>
        ) : (
          <div className="space-y-6 px-5">
            {playlists.map((playlist) => (
              <div key={playlist.id} className="card bg-base-200 shadow-xl">
                <div className="card-body p-4">
                  ...
                  {expandedPlaylist === playlist.id && (
                    <div className="mt-4 pt-4 border-t border-base-300">
                      ...
                      {playlist?.problems?.length === 0 || !playlist?.problems ? (
                        <div className="alert">
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <button
                          ...
                          className="btn btn-sm bg-red-500/70 hover:bg-red-500 text-red-100 hover:text-white rounded-md"
                        >
                          Delete Playlist
                        </button>
                      </div>
